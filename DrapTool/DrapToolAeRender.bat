...
rem --------------------------------
:lossless
%aerender% -project %filelocation% -comp "%composition%" -RStemplate "Best Settings" -OMtemplate "Lossless" -sound ON -v "ERRORS_AND_PROGRESS" -mp -output "%filepath%exported\%composition%.avi"
goto :eof
